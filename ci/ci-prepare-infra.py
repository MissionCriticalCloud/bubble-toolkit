...
@click.option('--timeout', help='Deployment timeout', default=900, required=False)
...
def main(**kwargs):
    ...
    ci.prepare(timeout=kwargs.get('timeout'), cloudstack_deploy_mode=kwargs.get('cloudstack'))
    print("==> Creating hosts went ok!")
    return 0
