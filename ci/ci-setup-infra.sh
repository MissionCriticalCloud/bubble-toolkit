...
function deploy_cosmic_db {
  ...
  mysql -h ${csip} -u cloud -pcloud cloud -e "INSERT INTO cloud.configuration (instance, name, value) VALUE('DEFAULT', 'consoleproxy.url.domain', 'cloud.lan') ON DUPLICATE KEY UPDATE value = '*.cloud.lan';"
  mysql -h ${csip} -u cloud -pcloud cloud -e "INSERT INTO cloud.keystore (name, certificate, \`key\`, domain_suffix, seq) VALUE('root', '-----BEGIN CERTIFICATE-----\r\\r\n-----END CERTIFICATE-----', NULL, '*.cloud.lan', 1);"
  mysql -h ${csip} -u cloud -pcloud cloud -e "INSERT INTO cloud.keystore (name, certificate, \`key\`, domain_suffix, seq) VALUE('CPVMCertificate', '-----BEGIN CERTIFICATE-----\r\\r\n-----END CERTIFICATE-----', '-----BEGIN RSA PRIVATE KEY-----\r\\r\n-----END RSA PRIVATE KEY-----', '*.cloud.lan', NULL);"
